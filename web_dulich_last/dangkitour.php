	...
	<form name="dangki" action="dangkitour.php" method="post" >
		<div class="container menu">	
					...
					<ul>
						...
						<li>
							...
							<li>
								...
								<div class="ttw-hrsub">
									<div class="ttw-hrsub-inner">
										<h4><a href="" target="blank">Đăng nhập</a></h4>
									</div>
								</div><!-- /ttw-hrsub -->
							</li>
						</ul>
			...
			<div class="container img" align="center">
				<img src="images/banner.jpg" alt="" width="1100px">
			</div>
			<br>
			...
			<div>
				...
				<div id="khung_dienthongtin">
					<table id="thongtinll" align="center" width="1100px" cellpadding="15px" cellspacing="15px">
						...
						<tr>
							<td height="30px" width="110px">Số người lớn</td>
							<td height="30px" width="110px"><input type="number" name="txtslnguoilon" min="1" max="20" value="1"></td>
							<!-- <td><input type="submit" name="btnthemdk" value="Thêm khung đăng kí"></td> -->
						</tr>
							<td height="30px">Số trẻ em</td>
							<td height="30px" width="110px"><input type="number" name="txtsltreem" min="0" value="0"></td>
